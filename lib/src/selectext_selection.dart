...
class SelectableTextSelectionOverlay {
  ...
  final SelectableTextRender renderObject;
  ...
  /// text field.
  final SelectableTextSelectionDelegate selectionDelegate;
  ...
  Widget _buildHandle(
    ...
    return FadeTransition(
        ...
        child: _SelectextSelectionHandleOverlay(
...
class _SelectextSelectionHandleOverlay extends StatefulWidget {
  const _SelectextSelectionHandleOverlay({
    Key key,
  ...
  @override
  _SelectableTextSelectionHandleOverlayState createState() =>
      _SelectableTextSelectionHandleOverlayState();
}

class _SelectableTextSelectionHandleOverlayState
    extends State<_SelectextSelectionHandleOverlay> {
